      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 lg:px-10 py-4">
          ...
          <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
            ...
            <Link 
              to="/schedule" 
              className="relative px-4 py-2 rounded-xl transition-all duration-300 group text-emerald-700 bg-emerald-50/80 shadow-sm"
            >
              Schedule
              <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-4/5 h-0.5 bg-gradient-to-r from-emerald-500 to-teal-500"></span>
            </Link>
            <Link 
              to="/myreports" 
              className="relative px-4 py-2 rounded-xl transition-all duration-300 group text-gray-600 hover:text-emerald-700 hover:bg-white/80"
